...
すでに[新規開発の終了も伝えられる](https://www.publickey1.jp/blog/23/javascriptwebpackturbopack.html) webpack ですが、「[STATE OF JS 2022](https://2022.stateofjs.com/ja-JP/)」ではいまだに利用率 No.1 の地位にあります。

![](https://storage.googleapis.com/zenn-user-upload/ce14acdcc577-20230423.png)

webpack 後継のモジュールバンドラーとしては、すでに [Turbopack](https://turbo.build/pack) の開発開始がアナウンスされています。しかし、これがプロダクションレベルに達するまでは webpack がおそらく使い続けられることになるでしょう。
